...
namespace CabInvoiceGeneratorAppTest
{
    ...
    public class UnitTest1
    {
        ...
        public void GivenUserIDInInvoice_GetsListofRides_ReturnAverageFareTotalFare()
        {
            ...
            EnhancedInvoiceSummary summary = cabInvoiceGenerator.GetInvoiceSummary("Snehal");
            EnhancedInvoiceSummary summary_New = cabInvoiceGenerator.GetInvoiceSummary("Mayur");
